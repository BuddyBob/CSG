...
for funcCount in range(0,20):
    for argCount in range(0,30):
        #title
        ...
        functionHeads = ["\tdef ${"+str(argCount+i+2)+":func"+str(i+1)+"}():"for i in range(funcCount)]
